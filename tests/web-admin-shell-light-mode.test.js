...
test('admin light mode skins the sidebar and top nav through theme-aware shell classes', () => {
  ...
  assert.match(cssSource, /\.admin-dashboard-sidebar-nav-button:hover\s*\{[^}]*background:\s*var\(--admin-shell-nav-active-bg\);[^}]*color:\s*var\(--admin-shell-primary-button-bg\) !important;/)
  assert.match(cssSource, /\.admin-dashboard-sidebar-nav-button\[data-active='true'\]\s*\{[^}]*background:\s*var\(--admin-shell-nav-active-bg\);[^}]*color:\s*var\(--admin-shell-primary-button-bg\) !important;/)

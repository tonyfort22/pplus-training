...
test('admin light mode skins the sidebar and top nav through theme-aware shell classes', () => {
  ...
  assert.match(cssSource, /\.admin-dashboard-sidebar-nav-button:hover\s*\{[^}]*background:\s*transparent !important;[^}]*box-shadow:\s*none !important;[^}]*color:\s*var\(--admin-shell-primary-button-bg\) !important;/)
  assert.match(cssSource, /\.admin-dashboard-sidebar-nav-button\[data-active='true'\]\s*\{[^}]*background:\s*transparent !important;[^}]*box-shadow:\s*none !important;[^}]*color:\s*var\(--admin-shell-primary-button-bg\) !important;/)
  assert.match(cssSource, /\.admin-dashboard-sidebar-nav-button:hover svg,[\s\S]*\.admin-dashboard-sidebar-nav-button\[data-active='true'\] svg\s*\{[^}]*color:\s*var\(--admin-shell-primary-button-bg\) !important;/)
  assert.match(cssSource, /\.admin-dashboard-sidebar-subnav-button:hover\s*\{[^}]*background:\s*transparent !important;[^}]*color:\s*var\(--admin-shell-primary-button-bg\) !important;/)
  assert.match(cssSource, /\.admin-dashboard-sidebar-subnav-button\[data-active='true'\]\s*\{[^}]*background:\s*transparent !important;[^}]*color:\s*var\(--admin-shell-primary-button-bg\) !important;/)
  assert.match(cssSource, /\.admin-dashboard-sidebar-subnav-button:hover svg,[\s\S]*\.admin-dashboard-sidebar-subnav-button\[data-active='true'\] svg\s*\{[^}]*color:\s*var\(--admin-shell-primary-button-bg\) !important;/)
  assert.match(cssSource, /\.admin-dashboard-sidebar \[data-sidebar='menu-button'\]\.admin-dashboard-sidebar-nav-button:hover,[\s\S]*background-color:\s*transparent !important;[\s\S]*color:\s*var\(--admin-shell-primary-button-bg\) !important;/, 'main sidebar tabs should force primary green text and transparent hover/selected backgrounds')
  assert.match(cssSource, /\.admin-dashboard-sidebar \[data-sidebar='menu-button'\]\.admin-dashboard-sidebar-nav-button:hover svg,[\s\S]*stroke:\s*var\(--admin-shell-primary-button-bg\) !important;/, 'main sidebar tab icons should force primary green on hover/selected')
  assert.match(cssSource, /\.admin-dashboard-sidebar \[data-sidebar='menu-sub-button'\]\.admin-dashboard-sidebar-subnav-button:hover,[\s\S]*background-color:\s*transparent !important;[\s\S]*color:\s*var\(--admin-shell-primary-button-bg\) !important;/, 'sidebar subtabs should force transparent backgrounds and primary green text on hover/selected')

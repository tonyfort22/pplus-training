...
test('admin dashboard overview body uses light-mode theme tokens for cards charts and controls', () => {
  ...
  assert.match(dashboardSource, /admin-shell-overview-performance-chart-svg/)
  assert.match(dashboardSource, /admin-shell-overview-chart-area-completed/)
  assert.match(dashboardSource, /admin-shell-overview-chart-area-assigned/)
  assert.match(dashboardSource, /admin-shell-overview-chart-line-completed/)
  assert.match(dashboardSource, /admin-shell-overview-chart-line-assigned/)
  assert.match(dashboardSource, /admin-shell-overview-card-value/)
  assert.match(dashboardSource, /pendingInvites:\s*Send/)
  ...
  assert.match(cssSource, /\.admin-shell-overview-performance-chart\s*\{[^}]*display:\s*block;/)
  assert.match(cssSource, /\.admin-shell-overview-chart-line-completed\s*\{[^}]*stroke:\s*#3be0af;/)
  assert.match(cssSource, /\.admin-shell-overview-chart-line-assigned\s*\{[^}]*stroke:\s*#58c6ff;/)
  assert.match(cssSource, /\.admin-shell-overview-session-chart\s*\{[^}]*grid-template-columns:\s*repeat\(auto-fit, minmax\(46px, 1fr\)\);/)

...
test('mobile screen styles exports the shared shell and renderer style keys', () => {
  ...
  assert.equal(styles.todayCard.backgroundColor, '#1f2937')
  assert.equal(styles.programCard.backgroundColor, '#1f2937')
  assert.equal(styles.workoutListCard.backgroundColor, '#1f2937')

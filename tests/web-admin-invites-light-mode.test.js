...
test('athlete invites admin view uses light-mode admin table tokens and safe invite actions', () => {
  ...
  assert.match(cssSource, /\.admin-shell-invites-example-pagination-button-active\s*\{[^}]*background:\s*var\(--admin-shell-primary-button-bg\);[^}]*color:\s*#0B1120;/)
  ...
  assert.doesNotMatch(invitesSource, /isCancelInviteSheetOpen/)

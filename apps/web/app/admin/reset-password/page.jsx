  ...
  return (
    <AdminPageShell>
      ...
      <div className="admin-auth-frame">
        ...
        <AdminCard aria-label="Reset password" className="admin-auth-signin-shell" layout="auth" padding="auth">
          ...
          <div className="admin-auth-signin-body">
            ...
            <div className="admin-auth-flow">
              <div className="admin-auth-title-row">
                <h1 className="admin-auth-title">{resetCopy.title}</h1>
                <p className="admin-auth-description">{resetCopy.description}</p>
              </div>

              <AdminResetPasswordForm resetCopy={resetCopy} language={language} />
            </div>
          </div>
        </AdminCard>
      </div>

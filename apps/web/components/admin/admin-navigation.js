export const adminNavigation = [
  ...
  },
  {
    ...
    title: 'All athletes',
    description: 'Manage athlete records, invitations, groups, and progress tracking from one place.',
    items: [
      {
        id: 'athletes-all',
        label: 'All athletes',
      ...
      },
      {
        ...
        description: 'Handle invitation codes, pending onboardings, and invite follow-up.',
      },
      {
        id: 'athletes-groups',
        label: 'Groups',
        ...
        description: 'Organize athletes into training groups, teams, and shared coaching cohorts.',
      },
      {
        id: 'athletes-progress',
        label: 'Progress',
        href: '/admin/athletes/progress',
        title: 'Athlete progress',
        description: 'Review athlete development, trends, and progress snapshots from the admin side.',
      },
    ],
  },
  {

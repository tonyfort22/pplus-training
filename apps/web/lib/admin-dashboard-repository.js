    ...
    async getOverview({ range = 'last-month' } = {}) {
      ...
      const summary = {
        ...
        programs: createSummaryMetric({
          ...
          footerSubtext: activePrograms.length ? `${assignedProgramCount} of ${activePrograms.length} assigned programs` : 'No assigned programs yet',
        ...
        workouts: createSummaryMetric({
          ...
          footerSubtext: activeWorkoutTemplates.length ? `${assignedWorkoutTemplateCount} of ${activeWorkoutTemplates.length} assigned workouts` : 'No assigned workouts yet',
        ...
        exercises: createSummaryMetric({
          ...
          footerSubtext: exercises.length ? `${usedExerciseCount} of ${exercises.length} used in workouts` : 'No exercises used in workouts yet',
        ...
        invites: createSummaryMetric({
          ...
          footerSubtext: inviteCount ? `${acceptedInviteCount} of ${inviteCount} accepted invites` : 'No accepted invites yet',

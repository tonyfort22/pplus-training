import { createWorkoutCalendarRepository } from './workout-calendar-repository.js'
...
export function createWorkoutCalendarRouteHandlers({
  repositoryFactory = createWorkoutCalendarRepository,
} = {}) {
  return {
    async GET(request) {
      try {
        const repository = repositoryFactory()
        const url = new URL(request?.url || 'http://localhost/api/admin/workout-calendar')

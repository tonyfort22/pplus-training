    ...
    login: {
      ...
      form: {
        ...
        forgot: {
          ...
          description: 'Enter your admin email and we’ll send a secure reset link if the account exists.',
          email: 'Email',
          submit: 'Send reset link',
          submitting: 'Sending...',
          success: 'If an account exists for that email, a reset link has been sent.',
          error: 'We could not send a reset link. Please try again.',
          backToLogin: 'Back to sign in',
        },
        reset: {
          title: 'Create a new password',
          description: 'Enter and confirm your new admin password.',
          password: 'New password',
          confirmPassword: 'Confirm password',
          submit: 'Update password',
          submitting: 'Updating...',
          missingToken: 'This reset link is missing or expired. Request a new password reset link.',
  ...
  fr: {
    ...
    login: {
      ...
      form: {
        ...
        error: 'Nous n’avons pas pu te connecter. Vérifie ton courriel et ton mot de passe, puis réessaie.',
        forgotPassword: 'Mot de passe oublié',
        forgot: {
          title: 'Mot de passe oublié ?',
          description: 'Entre ton courriel admin et nous enverrons un lien de réinitialisation sécurisé si le compte existe.',
          email: 'Courriel',
          submit: 'Envoyer le lien',
          submitting: 'Envoi...',
          success: 'Si un compte existe pour ce courriel, un lien de réinitialisation a été envoyé.',
          error: 'Nous n’avons pas pu envoyer de lien de réinitialisation. Réessaie.',
          backToLogin: 'Retour à la connexion',
        },
        reset: {
          title: 'Créer un nouveau mot de passe',
          description: 'Entre et confirme ton nouveau mot de passe admin.',
          password: 'Nouveau mot de passe',
          confirmPassword: 'Confirmer le mot de passe',
          submit: 'Mettre à jour le mot de passe',
          submitting: 'Mise à jour...',
          missingToken: 'Ce lien de réinitialisation est manquant ou expiré. Demande un nouveau lien.',
          mismatch: 'Les mots de passe ne correspondent pas.',
          tooShort: 'Le mot de passe doit contenir au moins 6 caractères.',
          error: 'Nous n’avons pas pu mettre à jour ton mot de passe. Réessaie.',
